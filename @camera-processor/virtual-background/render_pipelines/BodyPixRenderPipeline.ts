...
class BodyPixRenderPipeline extends RenderPipeline {
  private readonly maskCanvas: HTMLCanvasElement = document.createElement('canvas');
  private readonly maskCtx: CanvasRenderingContext2D = this.maskCanvas.getContext('2d');
...
export default BodyPixRenderPipeline;
